...
<body>
	...
	<div class="agile-main-top">
       ...
       Object rd=sc.getAttribute("r_id");  /* taking r_id in here */
       Object Name=sc.getAttribute("UserName");
       String Names=(String) Name;
       
       String r_id=(String)rd;
       System.out.println("Here Get"+Names+"GGGGG-"+r_id);
       ...
       %>
		...
		<li>
          <button type="button" class="btn btn-default btn-sm" style="height:50px;width:200px;">
          
        </button>
        </li>
		<%}else{ %>
				    <a href="index.jsp"><li style="margin-top:12px; ">
      <%="hi" +" "+Names %>         
          
        </li></a>  
        </li>
            <li>
          <a href="UserLogoutrrr">Logout</a>          
				...
				<div class="modal-body">
					<form action="UserLogin" method="post">
 						 ...
 						 <div class="container signin">
    						<p>New to PANCHRATNA? <a href="UserRegister.html">Register</a>.</p>
  						</div>
					</form>
				...
				<div class="col-md-6 logo_agile">
					<h1 class="text-center">
						<a href="index.html" class="font-weight-bold font-italic">
							<img src="images/logo2.png" alt=" " class="img-fluid">Panchratna Stationery
						</a>
					</h1>
				</div>
				<!-- //logo -->
						...
						<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
							...
							<div class="dropdown-menu">
								<div class="agile_inner_drop_nav_info p-4">
									<h5 class="mb-3">Stationery products</h5>
									<div class="row">
										...
										<div class="col-sm-6 multi-gd-img">
											<ul class="multi-column-dropdown">
												...
												<li>
													<a href="product.html">Clips</a>
												</li>
												<li>
													<a href="product.html">Envelope</a>
												</li>
												<li>
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 product-sec2 px-sm-5 px-3">
							<div class="row">
								<h3 class="col-md-4 effect-bg">Summer Offer</h3>
								<!-- <p class="w3l-nut-middle">Get Extra 10% Off</p> -->
								<div class="col-md-8 bg-right-nut">
									<img src="download/summer2.png" style="height: 250px;width: 450px;" alt="">
								</div>
							</div>
						</div>
						<!-- //third section -->
						...
						<!-- starts here any heading place above the <percentage  -->
								<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
							<h3 class="heading-tittle text-center font-italic">Paint Brush</h3>
							<div class="row">
						<% 
								...
								<div class="scroll">
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="download/best1.jpg"  alt="" class="img-fluid">
										</div>
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											<a href="">Nourish A5 Size Daily Planner</a>
											<a href="" class="price-mar mt-2">Rs.249.00</a>
										</div>
									</div>
									<div class="row my-4">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="download/best2.jpg" alt="" class="img-fluid">
										</div>
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											<a href="">Faber-Castell Light House(Multicolor)</a>
											<a href="" class="price-mar mt-2">Rs.205.00</a>
										</div>
									</div>
									<div class="row my-4">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="download/best4.jpg" alt="" class="img-fluid">
										</div>
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											<a href="">Prismacolor Sanford Premier Colour Pencils - Pack Of 72</a>
											<a href="" class="price-mar mt-2">Rs.6115.00</a>
										</div>
									</div>
									<div class="row my-4">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="download/mark12.jpg" alt="" class="img-fluid">
										</div>
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											<a href="">Karin Metalic Marker</a>
											<a href="" class="price-mar mt-2">Rs.1000.00</a>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="download/best3.jpg" alt="" class="img-fluid">
										</div>
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											<a href="">Derwent Lightfast Colouring Pencils Tin (Pack of 12, Multicolour)</a>
											<a href="" class="price-mar mt-2">Rs.1726.00 </a>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="row">
					...
					<div class="join-agile text-left p-4">
						<div class="row">
							<div class="col-sm-7 offer-name">
								<h6>Get Scientific</h6>
								<h4 class="mt-2 mb-3">Best In Calculators at an Effordable Price</h4>
								<p>Sale up to 25% off </p>
							</div>
							<div class="col-sm-5 offerimg-w3l">
								<img src="download/calc3.jpg"  alt="" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-6 mt-lg-0 mt-5">
					<div class="join-agile text-left p-4">
						<div class="row ">
							<div class="col-sm-7 offer-name">
								<h6>A Better Brush</h6>
								<h4 class="mt-2 mb-3">Best Paint Brush For Your Canvass</h4>
								<p>Free shipping on order above Rs.700</p>
							</div>
							<div class="col-sm-5 offerimg-w3l">
								<img src="download/brush.jpg" alt="" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
