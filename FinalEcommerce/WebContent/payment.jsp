...
<body>
       ...
       if(Names==null){
   		...
   		RequestDispatcher yy=request.getRequestDispatcher("UserLogin.jsp");
   		yy.include(request, response);	
									...
									<div class="row">
										<div class="col-sm-6 multi-gd-img">
											<ul class="multi-column-dropdown">
												<li>
													<a href="product.jsp?"> Pen</a>
												</li>
												<li>
													<a href="marker.jsp">Marker</a>
												</li>
												<li>
													<a href="product.jsp">Pencil</a>
												</li>
												<li>
													<a href="product.jsp">Calculator</a>
												</li>
												<li>
										...
										<div class="col-sm-6 multi-gd-img">
											<ul class="multi-column-dropdown">
												<li>
													<a href="product.jsp?procat=<%=Brush%>">Brush</a>
												</li>
												<li>
...
resultSet = statement.executeQuery("SELECT * From cart INNER JOIN products ON cart.p_id=products.p_id WHERE cart.r_id="+r_id);
while(resultSet.next()){
count++;
	System.out.println(resultSet.getString("r_id"));
...
%> 
	...
	<tbody class="tbody" style="height: 200px; text-align:left;  overflow: scroll;">
      <tr>
        ...
        <td><img src="images/product/<%=resultSet.getString("r_id") %>.jpg" style="height: 100px;width: 100px;" alt=""></td>
...
<img src="images/product/<%=resultSet.getString("p_id") %>.jpg" style="height: 200px;width: 200px;" alt="">
